    ...
    <div className="w-full h-full font-custom pt-4 px-4">
      ...
      <div className="py-8">
        <div className="flex flex-col items-center justify-center">
          ...
          <h1 className="py-4 text-center font-custom font-semibold text-[36px] md:text-[48px] leading-[42px] md:leading-[54.72px] tracking-normal">Unlock New Revenue Streams <br/>Optimize Your <span className="font-cursive font-regular tracking-[-0.2rem] text-[#4E64EE]">Occupancy</span></h1>
          <p className="text-[20px] py-4 text-[#2D5087] text-center"> Respondents input their real-world demographics, interests, and behaviours <br/>directly into your system.
          </p>
        </div>
