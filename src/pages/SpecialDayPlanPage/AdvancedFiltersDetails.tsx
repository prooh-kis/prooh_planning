...
export const AdvanceFiltersDetails = ({
  ...
  const [dataBrand, setDataBrand] = useState<any[]>(campaignDetails?.advanceFilterData?.stores?.[0]?.brands || []);
  const [dataComp, setDataComp] = useState<any[]>(campaignDetails?.advanceFilterData?.stores?.[0]?.comp || []);
  ...
  }, [dispatch, campaignId, pathname, campaignDetails, errorAddDetails, errorAdvanceFilterData]);
