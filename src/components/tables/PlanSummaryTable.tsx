        ...
        <table className="w-full border border-1 ">
          <thead>
            <tr className="py-1 h-[40px] bg-[#F1F9FF] border border-1">
              ...
              <th className="border border-1">Impressions/Day</th>
              <th className="border border-1">Slots/Day</th>
              <th className="border border-1">Price/slot</th>
            ...
            <tbody className="w-full">
              {Object.keys(data)
                ...
                ${i === Object.keys(data).length - 1 ? "" : ""}
                  ...
                  >
                    <td className="border py-2 border-1 text-center">
