...
export const CampaignDashboardScreenshots = ({
  ...
  setLoading,
      ...
      if (window.location.search.includes('screenshot=true')) {
        ...
        if (dashboardSS && jobId) {
          ...
          webSocket.on("connect", () => {
            webSocket.emit("subscribeToDashboardScreenshotsJob", dashboardSS.screenshotjob);
          });
            ...
            switch (socketStatus) {
              case "completed":
                ...
                if (update.result) {
                  ...
                  setDashboardScreenshots(downloadableUrls?.map((url: any) => url.url));
                }
    ...
    }, [dispatch, dashboardSS, jobId, setSocketUpdateStatus, setLoading, setJobId, setDashboardScreenshots]);
