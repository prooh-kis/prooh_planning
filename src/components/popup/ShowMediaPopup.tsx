...
import { ImageContainer, VideoContainer } from "../../components/molecules/ShowMyFile";
                ...
                {creativesToShow.screenId === "" ? (
                  ...
                  <div className="w-full">
                    <div className="p-2 flex items-end gap-2 border-b">
                      <h1 className="md:text-[14px] sm:text-[12px]">Screen Name:</h1>
                      <h1 className="md:text-[16px] sm:text-[14px] font-bold">{creativesToShow?.screenName}</h1>
                    </div>
                      ...
                      <div key={i}>
                        <div className="border-b p-2">
                          ...
                          <h1 className="md:text-[14px] sm:text-[12px]">
                            {creativesToShow?.creatives[c.value]?.length} creatives
                          </h1>
                        </div>
                        {creativesToShow?.creatives[c.value]?.map((cr: any, j: any) => (
