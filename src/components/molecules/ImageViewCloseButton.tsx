...
export const ImageViewCloseButton = ({ file, removeImage }: any) => {
  return (
    <div className="relative inline-block">
      ...
      />
      <i onClick={() => removeImage(file)} className="fi fi-sr-cross-circle flex items-center justify-center absolute top-0 right-0 focus:outline-none hover:bg-red-700 text-[#FF0808]"></i>
