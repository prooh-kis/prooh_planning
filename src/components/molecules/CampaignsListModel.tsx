  ...
  return (
    <div className="flex items-center justify-between w-full rounded-[12px] bg-white p-4 my-2">
      <div className="flex items-top gap-4">
        <div
          className={clsx(`rounded-[12px] flex justify-center items-center w-24 border border-[#D7D7D750] bg-[${
        ...
        <div>
          ...
          <div className="flex gap-2 items-center my-1">
            <div className="bg-[#FF5D2710] px-2 py-1 rounded-[8px]">
              <h1 className="text-[#FF5D27] text-[12px] truncate">{data?.brandName}</h1>
            </div>
            <div className="bg-[#7A6EC110] px-2 py-1 rounded-[8px]">
              <h1 className="text-[#7A6EC1] text-[12px] truncate">{data?.clientName}</h1>
            </div>
            <div className="bg-[#129BFF10] px-2 py-1 rounded-[8px]">
              <h1 className="text-[#129BFF] text-[12px] truncate">{data?.campaignType}</h1>
            </div>
          </div>
          <h1 className="text-[14px] text-[#276F41] font-semibold">&#8377;{data?.totalCampaignBudget?.toFixed(0)}</h1>
