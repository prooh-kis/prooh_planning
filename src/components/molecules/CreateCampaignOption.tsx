  ...
  return (
    <div className="border border-black w-full p-8 sm:px-40 bg-[#129BFF] flex flex-col sm:flex-row justify-between mt-4 lg:mt-8">
      <div>
        ...
        <button
          className="bg-[#FFFFFF] text-black px-[20px] sm:px-[58px] py-[10px] sm:py-[20px] rounded-[9px] text-[14px] sm:text-[16px] font-bold mt-8 hover:bg-black hover:text-[#FFFFFF] hover:text-[18px]"
