...
import { CAMPAIGN_STATUS_PLEA_REQUEST_SCREEN_APPROVAL_ACCEPTED, CAMPAIGN_STATUS_PLEA_REQUEST_SCREEN_APPROVAL_REJECTED } from "../../constants/campaignConstants";
    ...
    <div className="dropdown">
      ...
      <div className="dropdown-content">
        <div 
          ...
          className="flex flex-row gap-4 items-center py-2 px-4 hover:bg-sky-600 hover:text-white"
        >
