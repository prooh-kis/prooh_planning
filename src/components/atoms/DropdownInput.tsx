...
export const DropdownInput = ({
  ...
  return (
    <div className={height ? "relative" : "relative w-full"}>
      <select
        title="dropdown"
        className={`truncate w-full ${dropdownHeight} ${dropdownWidth} text-[14px] border rounded-lg ${height ? "pr-4 pl-2" : "px-3"} py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-gray-100 active:bg-blue-100 transition-colors appearance-none`}
