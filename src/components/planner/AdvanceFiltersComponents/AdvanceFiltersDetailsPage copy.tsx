...
import { LocationProximity } from "../../segments/LocationProximity";
...
export const AdvanceFiltersDetailsPage = ({
  ...
  const handleFinalSelectedScreens = ({ type, screens }: any) => {
    ...
    setFinalSelectedScreens((prevScreens: any) => {
      console.log("routeFilte", routeFilteredScreens);
      console.log("polygonFilte", polygonFilteredScreens);
      if (type === "add") {
        ...
        console.log("adding", excelFilteredScreens.length, routeFilteredScreens.length, polygonFilteredScreens.length, screens.length)
        const uniqueScreens = getUniqueScreens([{ screens: updatedScreens }]);
        return uniqueScreens;
      } else if (type === "remove") {
        console.log("removing", screens.length)
